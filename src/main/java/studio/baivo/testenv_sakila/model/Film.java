...
public class Film {
    ...
    @ManyToMany
    @JoinTable(name = "FILM_ACTOR",  schema = "SAKILA", joinColumns = @JoinColumn(name = "FILM_ID", referencedColumnName = "FILM_ID",insertable=false, updatable=false), inverseJoinColumns = @JoinColumn(name = "ACTOR_ID", referencedColumnName = "ACTOR_ID", insertable=false, updatable=false))
    ...
    @ManyToMany
    @JoinTable(name = "FILM_CATEGORY",schema = "SAKILA", joinColumns = @JoinColumn(name = "FILM_ID", referencedColumnName = "FILM_ID", insertable=false, updatable=false), inverseJoinColumns = @JoinColumn(name = "CATEGORY_ID", referencedColumnName = "CATEGORY_ID", insertable=false, updatable=false))
